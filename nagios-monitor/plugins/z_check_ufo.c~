/*
  ...
  Project    : ufo checker
             : Make to check the unknown -_-'
  Created on : Friday December 1 2017

  Write with Emacs-Nox ──────────────────────────┐
  C - UFO Checker - Made for unknonwn analysis ──┘

  using gcc -std=c11 -Wall -g -o a a.c
  c11 oblige the use of setenv / putenv declaration rather than gnu11

  to improve security level use pedantic and -W option:
  time gcc -std=c11 -fstack-protector-strong -Wpedantic -pedantic-errors -W -Wall -g -O3 -Os -Og -o a a.c
*/

const char *progname = "z_check_ufo";
const char *copyright = "2017";
const char *email = "aurelien.desbrieres.ext@zodiacaerospace.com";
...
#include "includes/popen.h"
#include "includes/utils.h"

#define WARN_DUPLICATES "DUPLICATES FOUND!"
#define UNKNOW_TRIP_TIME -1.0                                              // -1 seconds

// Function definition
/* #define MAX_INPUT_BUFFER 4096 */
/* #define FALSE */
/* #define UNKNOW_TRIP_TIME */
...
/* #define ERROR */
/* #define SIGALRM */
/* #define popen_timeout_alarm_handler */
/* #define SIG_ERR */
/* #define timeout_interval */
/* #define PING_COMMAND */
/* #define STATE_CRITICAL */
/* #define STATE_WARNING */
/* #define UNKNOW_TRIP_TIME */
/* #define STATE_OK */
/* #define TRUE */
/* #define CGIURL */
...
print_help (void)
{
	...
	printf ("Copyright (C) 2017 Aurélien DESBRIERES <aurelien.desbrieres.ext@zodiacaerospace.com>\n");
